...
First, the energy distribution of a single photon was measured from the self-emission of PMTs. To avoid the environmental light detection, the TRITIUM-Aveiro prototype was removed and the measurement was carried out only with the PMTs used, the windows of which were covered with black caps. The output signals of the PMTs were digitalized, shaped and pulse-height measured by a CAEN V1724 digitalizer \cite{CAENV1724}.
...
\caption{The single-photon energy distribution of both PMTs used in the TRITIUM-Aveiro 0 prototype and their sum.\label{fig:SinglePhotonEnergyDistribution}}
\end{figure}
...
\caption{Measurement of a $\ce{^{55}Fe}$ radioactive source with the TRITIUM-Aveiro 0 prototype.\label{fig:55FeMeasurement}}
\end{figure}
...
Lastly, a passive shield test was performed in the DRIM laboratory to quantify the attenuation of the background produced by lead. To do so, the $\ce{^{55}Fe}$ radioactive source was removed and the prototype was filled with TAP WATER. Furthermore, the electronical chain explained in appendix \ref{} was used in counting mode for this test.
...
\caption{Measurement of the background with TRITIUM-Aveiro 0 prototype covered with different thicknesses of lead.\label{fig:LeadShieldTest}}
\end{figure}
...
\begin{figure}[h]
 ...
 \caption{Measurements of the background and tritium liquid source (with an activity of $29.8~\kilo\becquerel/\liter$) performed with the TRITIUM-Aveiro 0 prototype and integred during a minute.}
...
\caption{Measurements of the background and tritium liquid source (with an activity of $29.8~\kilo\becquerel/\liter$) performed with the TRITIUM-Aveiro 0 prototype and integred during an hour.\label{fig:Tritium60min}}
\end{figure}
