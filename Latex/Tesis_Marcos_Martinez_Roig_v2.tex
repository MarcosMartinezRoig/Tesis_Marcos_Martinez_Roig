...
\chapter[Design principles]{Design principles of the Tritium monitor}\label{chap:DesignPrinciples}
	...
	\newpage
		...
		\subsection{Readout system of photosensors}\label{subsec:Electronic}
			...
			\input{./Sections/2Design_Principles/22DetectorMonitor/224ElectronicalSystem/2243SiPMElectronicalSystem}\label{subsubsec:SiPMElectronicalSystem}
			%\newpage			
			
			\subsubsection[PETSYS (SiPMs)]{Electronical system for SiPMs arrays (PETSYS) }
			\input{./Sections/2Design_Principles/22DetectorMonitor/224ElectronicalSystem/2244PETSYS}\label{subsubsec:PETSYS}
			\newpage		
	...
	%\newpage
		...
		\subsection[Set up water system]{Set up of ultra pure water system} %\label{sec:Scintillators}
...
\input{./Sections/9Appendix/92ElectronicsParametersAppendix}

\chapter{And even more things}\label{App:C}
\input{./Sections/9Appendix/93AppendixC}
