The electronic system used in TRITIUM-Aveiro prototype consists of several PCB and can be divided into two parts:
\begin{enumerate}
...
\caption{Simplified electronic scheme used to process and analyze the signal of TRITIUM-Aveiro prototype. \label{fig:ElectronicSchemCounterBoard}}
\end{figure}
