...
The distribution of the number of photons detected by the PMTs per tritium event was obtained for the simulated TRITIUM-IFIC 2 prototype, shown in Figure \ref{fig:SimulatedPhotonsDetected}.
...
\begin{figure}[h]
 \centering
  \subfloat[Counts as a function of the time.]{
   \label{subfig:RawData1Det10Min250BqL}
    \includegraphics[width=0.5\textwidth]{8SimulationsResults/82TRITIUMMonitor/821TRITIUMIFIC2/RawData_1Det_10min_250BqL.pdf}}
   %\newline
  \subfloat[Distribution.]{
   \label{subfig:Dist1Det10Min250BqL}
    \includegraphics[width=0.5\textwidth]{8SimulationsResults/82TRITIUMMonitor/821TRITIUMIFIC2/Dist_1Det_10min_250BqL_and_Gaus.pdf}}
...
\begin{figure}[h]
 \centering
  \subfloat[Integration counting time of $10~\min$.]{
   \label{subfig:1Det10min250BqLST}
    \includegraphics[width=0.5\textwidth]{8SimulationsResults/82TRITIUMMonitor/821TRITIUMIFIC2/Dist_1Det_10min_250BqL.pdf}}
   %\newline
  \subfloat[Integration counting time of $30~\min$.]{
   \label{subfig:1Det30min250BqLST}
    \includegraphics[width=0.5\textwidth]{8SimulationsResults/82TRITIUMMonitor/821TRITIUMIFIC2/Dist_1Det_30min_250BqL.pdf}}
   \newline
  \subfloat[Integration counting time of $60~\min$.]{
   \label{subfig:1Det60min250BqLST}
    \includegraphics[width=0.5\textwidth]{8SimulationsResults/82TRITIUMMonitor/821TRITIUMIFIC2/Dist_1Det_60min_250BqL.pdf}}
...
\begin{figure}[h]
 \centering
  \subfloat[One TRITIUM-IFIC 2 prototype.]{
   \label{subfig:1Det10min250BqLSD}
    \includegraphics[width=0.5\textwidth]{8SimulationsResults/82TRITIUMMonitor/821TRITIUMIFIC2/Dist_1Det_10min_250BqL.pdf}}
   %\newline
  \subfloat[Five TRITIUM-IFIC 2 prototypes.]{
   \label{subfig:5Det10min250BqLSD}
    \includegraphics[width=0.5\textwidth]{8SimulationsResults/82TRITIUMMonitor/821TRITIUMIFIC2/Dist_5Det_10min_250BqL.pdf}}
   \newline
  \subfloat[Ten TRITIUM-IFIC 2 prototypes.]{
   \label{subfig:10Det10min250BqLSD}
    \includegraphics[width=0.5\textwidth]{8SimulationsResults/82TRITIUMMonitor/821TRITIUMIFIC2/Dist_10Det_10min_250BqL.pdf}}
...
\begin{figure}[h]
 \centering
  \subfloat[]{
   \label{subfig:ResolutionvsIntegrationCoutingTime}
    \includegraphics[width=0.5\textwidth]{8SimulationsResults/82TRITIUMMonitor/821TRITIUMIFIC2/Results_Several_Times.pdf}}
   %\newline
  \subfloat[]{
   \label{subfig:ResolutionvsNumberDetectors}
    \includegraphics[width=0.5\textwidth]{8SimulationsResults/82TRITIUMMonitor/821TRITIUMIFIC2/Results_Several_Detectors.pdf}}
