...
\chapter{TRITIUM Monitor Results and Discussion}\label{chap:ResultsPrototypes}
	...
	%\newpage
		...
		\section[Simulation Results of Optimized Shape of Tritiated Water Source]{Simulation Results of Optimized Shape of Tritiated Water Source}\label{sec:ResultsShapeSource}
		\input{./Sections/8SimulationResults/81ResultsShapeSourceSimulation}
		
		\section[Simulation Results of Optimized Scintillating Fiber Length]{Simulation Results of Optimized Scintillating Fiber Length}\label{sec:ResultsFiberLength}
		\input{./Sections/8SimulationResults/82ResultsScintillatingFiberLength}
		%\newpage
		
		\section[Simulation Results of Optimized Scintillating Fiber Diameter]{Simulation Results of Optimized Scintillating Fiber Diameter}\label{sec:ResultsFiberDiameter}
		\input{./Sections/8SimulationResults/83ResultsScintillatingFiberDiameter}
		%\newpage
		
		\section[Simulation Results of TRITIUM-IFIC 2]{Simulation Results of TRITIUM-IFIC 2}\label{sec:ResultsSimulatedTRITIUMIFIC2}
		\input{./Sections/8SimulationResults/84ResultsTritiumIFIC2}
		%\newpage
		...
		\input{./Sections/8SimulationResults/85ResultsBackgroundRejectionSystem}
		\newpage
