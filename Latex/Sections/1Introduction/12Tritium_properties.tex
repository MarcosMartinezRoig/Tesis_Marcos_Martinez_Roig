...
\centering
    ...
    \end{subfigure}
 \caption{Tritium activity levels in surface water around Cofrentes NPP from January $2006$ to November $2019$. The white points are the detection limit and the green points are the measured activity, when this is above the detection limit~\cite{REM}.}
