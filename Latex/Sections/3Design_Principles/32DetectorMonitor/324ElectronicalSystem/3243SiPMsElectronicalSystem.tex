...
\begin{figure}[htbp]
 \centering
  ...
  \subfloat[PCB 2 used to sum and amplify the output signals of SiPMs]{
   ...
   \newline
  \subfloat[PCB 3 used to rearrange the different singals of the system.]{
   \label{subfig:PCB3}
...
The output signal of the third PCB is connected to an oscilloscope, model ..., that records the data which are subsequently analized by ROOT\footnote{ROOT is a framework for data processing, based on C ++ and object-oriented technology, developed at CERN and widely used in nuclear and particle physics.}.