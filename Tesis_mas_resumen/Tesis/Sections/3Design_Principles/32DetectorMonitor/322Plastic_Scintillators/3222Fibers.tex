...
The trapping efficiency or photon collection efficiency is defined as the efficiency of the scintillator to guide photons. For BCF-12 fibers with optical clad this efficiency is between $3.4\%$ and $7\%$ per meter of fiber (depending on the emission point, it is minimum on the fiber axis and maximum near the core-clad interface). In Figure \ref{fig:Fiber_physic}, the light collection in a fiber is illustrated.

%Therefore, from the $148$ photons initially created by a tritium decay electron of $18.6~\keV$ and assuming a light yield of $8000$ photons$/\MeV$, around $137$ photons are guided along the $20~\cm$ fiber length of the TRITIUM detector, assuming a $7\%$ trapping efficiency and an exponencial attenuation with the fiber length. Thus, the output signal is small and is in the energy range of the spectrum where electronic noise is already significant. ->>CHECK THAT
