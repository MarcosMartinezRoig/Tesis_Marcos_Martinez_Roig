...
\chapter[Design principles]{Design principles of the Tritium monitor}\label{chap:DesignPrinciples}
	...
	\newpage
		...
		\subsection{Readout system of photosensors}\label{subsec:Electronic}
			...
			\input{./Sections/2Design_Principles/22DetectorMonitor/224ElectronicalSystem/2241ElectronicalSystemIntro}\label{subsec:IntroductionElectronicalSystem}
			%\newpage
			...
			\input{./Sections/2Design_Principles/22DetectorMonitor/224ElectronicalSystem/2243PETSYS}\label{subsubsec:PETSYS}
			\newpage		
...
\input{./Sections/9Appendix/92AppendixB}
