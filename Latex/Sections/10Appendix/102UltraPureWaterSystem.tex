...
\centering
    ...
    \centering
    \includegraphics[width=\textwidth]{9Appendix/94UltraPureWaterSystem/GrossFiltering.png}  
    \caption{Gross filtering stage.\label{subfig:GrossFiltering}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{9Appendix/94UltraPureWaterSystem/FineFiltering.png}  
    \caption{Fine filtering stage.\label{subfig:FineFiltering}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{9Appendix/94UltraPureWaterSystem/SuperFineFiltering.png}  
...
\centering
    \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{9Appendix/94UltraPureWaterSystem/Osmosi.png}  
    \caption{Doble phase reverse osmosis stage.\label{subfig:Osmosi}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{9Appendix/94UltraPureWaterSystem/Containers.png}  
...
\centering
    ...
    \centering
    \includegraphics[width=\textwidth]{9Appendix/94UltraPureWaterSystem/Siemens1.png}  
    \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{9Appendix/94UltraPureWaterSystem/Siemens2.png}  
    \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.27\textwidth}
    \centering
    \includegraphics[width=\textwidth]{9Appendix/94UltraPureWaterSystem/Siemens3.png}  
    \caption{}
    \end{subfigure}
