...
\begin{tabular}{lcccc}
\toprule 
Study & \parbox{5.5em}{$\varepsilon_{det}\times10^{-3}\\(\frac{\liter}{\kilo\becquerel~\second})$}  & \parbox{4.5em}{$F_{sci}$ ($\cm^2$)}  & \parbox{6.5em}{$\eta_{det}\times 10^{-6}\\(\frac{\liter}{\kilo\becquerel~\second~\cm^2})$} & MDA ($\kilo\becquerel / \liter$) \tabularnewline
\midrule
\midrule 
...
T-IFIC-0$\dagger$ & $2.1 \pm 0.8$ & $219.91$ & $10 \pm 4$ & $100$* \tabularnewline
T-IFIC-1$\dagger$ & $38.4 \pm 1.6$ & $402.12$ & $96 \pm 4$ & $100$* \tabularnewline
T-Aveiro$\dagger$ & $64 \pm 19$ & $4071.50$ & $16 \pm 5$ & $5$** \tabularnewline
T-IFIC-2$\dagger$ & $711 \pm 27$ & $5026.55$ & $141 \pm 6$ & $0.22$** \tabularnewline
\bottomrule
\end{tabular}
