...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.4]{3DesignPrinciples/32Tritium_detector/JablonskyDiagram.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.4]{3DesignPrinciples/32Tritium_detector/StokesShift.png}
