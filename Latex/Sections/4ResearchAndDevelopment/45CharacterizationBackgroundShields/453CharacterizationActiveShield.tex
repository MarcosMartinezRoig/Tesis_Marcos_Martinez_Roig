...
\centering
    ...
    \caption{Fit of the cosmic veto rate versus distance to a second degree polynomial.\label{subfig:LinearFitSeveralDistanceVeto}}
    \end{subfigure}
 \caption{Measurement of the cosmic veto for several distances between the two scintillators.}
