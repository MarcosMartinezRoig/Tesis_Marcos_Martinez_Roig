...
\end{figure}
To find the MDA, tritiated water was slowly added  so that the tritium water activity increased continuously till reaching the $N_D'$ value. A rate of $(656 \pm 26)~\min^{-1}$ was obtained that corresponds to an MDA=$(29.8\pm 3.6)~\kilo\becquerel/\liter$ measured with a Quantulus LSC.
