...
\begin{figure}[htbp]
 \centering
  \subfloat[PCB 1 used to arrang 8 SiPMs and black box.]{
   \label{subfig:PCB1}
    \includegraphics[width=0.5\textwidth]{3DesignPrinciples/32Tritium_detector/PCB1_SiPM_Black_Box.jpg}}
  \subfloat[PCB 2 used to sum and amplify the output signals of SiPMs]{
   \label{subfig:PCB2}
    \includegraphics[width=0.5\textwidth]{3DesignPrinciples/32Tritium_detector/PCB2_SIPMs.jpg}}
   \newline
  \subfloat[PCB 3 used to arrange the different singals of the system.]{
   \label{subfig:PCB3}
    \includegraphics[width=0.5\textwidth]{3DesignPrinciples/32Tritium_detector/PCB3_SiPMs.jpeg}}
