...
\chapter{TRITIUM Monitor Results and Discussion}\label{chap:ResultsPrototypes}
	...
	%\newpage
		...
		\section[Simulation Results to optimize the TRITIUM monitor design]{Simulation Results to optimize the TRITIUM monitor design}\label{sec:ResultsTRITIUMSimulationsDesign}
		\input{./Sections/8SimulationResults/81TRITIUMSimulationsforImprovingDesign/810IntroImprovingDesignTRITIUM}		
		
			\subsection[Simulation Results of Optimized Shape of Tritiated Water Source]{Simulation Results of Optimized Shape of Tritiated Water Source}\label{subsec:ResultsShapeSource}
			\input{./Sections/8SimulationResults/81TRITIUMSimulationsforImprovingDesign/811ResultsShapeSourceSimulation}
		
			\subsection{Simulation Results of Output Light of Scintillating Fibers}\label{subsec:ResultsOutputLight}
			\input{./Sections/8SimulationResults/81TRITIUMSimulationsforImprovingDesign/812ResultsOutputLight}
		%\newpage			
			
			\subsection[Simulation Results of Optimized Scintillating Fiber Length]{Simulation Results of Optimized Scintillating Fiber Length}\label{subsec:ResultsFiberLength}
			\input{./Sections/8SimulationResults/81TRITIUMSimulationsforImprovingDesign/813ResultsScintillatingFiberLength}
		%\newpage
		
			\subsection[Simulation Results of Optimized Scintillating Fiber Diameter]{Simulation Results of Optimized Scintillating Fiber Diameter}\label{subsec:ResultsFiberDiameter}
			\input{./Sections/8SimulationResults/81TRITIUMSimulationsforImprovingDesign/814ResultsScintillatingFiberDiameter}
		%\newpage
		
			\subsection[Tritium signal enhancement due to use of PMMA windows]{Tritium signal enhancement due to use of PMMA windows}\label{subsec:ResultsPMMAWindows}
