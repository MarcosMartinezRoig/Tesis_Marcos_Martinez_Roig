...
\chapter{TRITIUM Monitor Results and Discussion}\label{chap:ResultsPrototypes}
	...
	%\newpage
		...
		\input{./Sections/8SimulationResults/81TRITIUMSimulationsforImprovingDesign/810IntroImprovingDesignTRITIUM}		
			...
			\input{./Sections/8SimulationResults/81TRITIUMSimulationsforImprovingDesign/812ResultsScintillatingFiberLength}
		%\newpage
			...
			\input{./Sections/8SimulationResults/81TRITIUMSimulationsforImprovingDesign/813ResultsScintillatingFiberDiameter}
		%\newpage
		
		\section[Simulation Results of TRITIUM-IFIC 2]{Simulation Results of TRITIUM-IFIC 2}\label{sec:ResultsSimulatedTRITIUMIFIC2}
		\input{./Sections/8SimulationResults/82TRITIUMIFIC2Simulations/821ResultsTritiumIFIC2}
		%\newpage
		
		\section[Simulation Results of Background Rejection System]{Simulation Results of Background Rejection System}\label{sec:ResultsSimulatedBackgroundRejectionSystem}
		\input{./Sections/8SimulationResults/83BackgroundRejectionSystemSimulations/831ResultsBackgroundRejectionSystem}
		\newpage
