Plastic scintillators are easy to machine to any desired shape. The chosen shape for the TRITIUM detector is the fibre, specifically, commercial fibres BCF-12 from Saint-Gobain Crystals Inc \cite{DataSheetBCF12Fiber}. This type of fibre was chosen as the result of a comparative study \cite{TFGAlberto} among some of the best-known commercial manufacturers. The BCF-12 fibres consist of a scintillating polystyrene core with the possibility of being covered by polymethyl methacrylate (PMMA) claddings. % (smaller refractive index than core in order to archieve a critical angle) or a multicladding (second cladding) with even smaller refractive index.
