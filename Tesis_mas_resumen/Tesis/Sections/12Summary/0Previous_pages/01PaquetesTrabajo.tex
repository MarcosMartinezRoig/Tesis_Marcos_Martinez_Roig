...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RO]{Resum en Valencià}
%\fancyhead[LE]{\rightmark} %\leftmark -> highest level; \rightmark ->higher

%Estos funcionan bien con book
%\fancyhead[RO]{Resum en Valencià}
%\fancyhead[LE]{\rightmark} %\leftmark -> highest level; \rightmark ->higher level
